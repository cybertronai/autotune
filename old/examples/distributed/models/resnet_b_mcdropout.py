...
from torchcurv.utils.accumulator import TensorAccumulator
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
                 base_width=64, norm_layer=None, norm_stat_momentum=0.1, dropout_ratio=0.5):
