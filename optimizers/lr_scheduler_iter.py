...
class _LRScheduler_iter(object):
...
class PolynomialDecayLR(_LRScheduler_iter):
    ...
    def __init__(self, optimizer, rate, max_count, target=None, start_iter=0, last_iter=-1):
        ...
        super(PolynomialDecayLR, self).__init__(optimizer, last_iter)
...
class GradualWarmupLR(_LRScheduler_iter):
    """Set the learning rate of each parameter group to the initial lr decayed
    by gamma every iter. When last_iter=-1, sets initial lr as lr.
    ...
    def __init__(self, optimizer, initial_lr, max_count, last_iter=-1):
        ...
        self.max_count = max_count
        super(GradualWarmupLR, self).__init__(optimizer, last_iter)
